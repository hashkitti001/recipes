...
import { getAllRecipes, getRecipeById, createNewRecipe, deleteRecipe, updateRating } from '../controllers/recipeController'
...
privateRouter.put('/api/recipe/:id/rate', authMiddleware, updateRating)
