    ...
    <div className="flex bg-400 rounded-xl p-6 relative">
      <div className="">
        ...
        <div className="calories flex justify-between p-4 gap-4">
          ...
          {showSharePopup && (
            <div className="absolute top-28 right-20 bg-white shadow-md p-4 rounded-lg flex gap-4 z-10 opacity-90">
      ...
      <div className="recipecard-img absolute left-[14rem] top-2">
        <img
          src={imgURL}
          className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 rounded-full object-cover mb-2 aspect-square"
          alt={name}
        />
      </div>
    </div>
